...
void TEST10() {
    ...
    to << eurovision << endl;
    eurovision += p34;
    to << eurovision.participate("germany") << endl;
    eurovision += p24;
    eurovision += p25;
    eurovision += p34;
    eurovision += p34;
    ...
    to << eurovision << endl;
    to<<p34.isRegistered()<<endl;
}
MainControl eurovisioncheck;
    to<<p34.isRegistered()<<endl;
    eurovisioncheck+=p34;
    to<<eurovisioncheck.participate("germany")<<endl;
    to<<eurovisioncheck<<endl;
    eurovisioncheck.setPhase(Contest);
    eurovisioncheck.setPhase(Voting);
    eurovisioncheck.setPhase(Contest);
    to<<eurovisioncheck<<endl;
    to<<eurovisioncheck(1,All)<<endl;
}