...
void TEST4(){
    ...
    eurovision+=Vote(v62,"norway","spain","ireland","france","germany","armenia");
    ...
    eurovision+=Vote(v19,"latvia","russia","belgium","andora");
    ...
    eurovision+=Vote(v9,"netherlands","switzerland","lithiania","serbia","malta","bosnia","croatia","andora");
    ...
    eurovision+=Vote(v55,"armenia","spain","cyrpus","slovakia","serbia");
