...
void TEST1(){
    ...
    cout<<eurovision.participate("france")<<endl;
    ...
    eurovision+=Vote(v46,"belarus","armenia","serbia","austria","moldova","sweden","bosnia","italy");
    ...
    eurovision+=Vote(v29,"bosnia","netherlands","andora","moldova","belarus","kazakhastan","slovakia","croatia","spain");
    ...
    eurovision+=Vote(v22,"israel","hungary","spain","kazakhastan");
