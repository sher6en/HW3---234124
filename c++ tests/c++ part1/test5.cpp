...
void TEST5(){
    ...
    eurovision+=Vote(v33,"bulgaria","hungary","georgia");
    eurovision+=Vote(v54,"lithiania","norway","armenia","slovenia","hungary","cyrpus");
    ...
    eurovision+=Vote(v38,"armenia","turkey","bosnia","moldova","croatia","germany");
    ...
    eurovision+=Vote(v47,"italy","sweden","croatia","israel","georgia","norway","slovenia","switzerland");
    ...
    eurovision+=Vote(v24,"netherlands","belarus","spain","ireland","austria","luxembourg","estonia");
